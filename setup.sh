...
non_ws_response = "Hii! You should join discord.gg/7Qh7qWs6Du"
...
run_task "Configuring and starting services" "All services are up and running" '
  ...
  # Quote PATH to avoid splitting when Windows paths with spaces are present under WSL
  sudo env "PATH=$PATH:$HOME/.bun/bin" "$HOME/.bun/bin/pm2" startup systemd -u "$USER" --hp "$HOME"
'

info "Setup completed! Your Current instance is now up and ready to be used!!!!"
